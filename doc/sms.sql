...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='优惠券信息';
...
CREATE TABLE `sms_coupon_history` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='优惠券领取历史记录';
...
CREATE TABLE `sms_coupon_spu_category_relation` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='优惠券分类关联';
...
CREATE TABLE `sms_coupon_spu_relation` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='优惠券与产品关联';
...
CREATE TABLE `sms_home_adv` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='首页轮播广告';
...
CREATE TABLE `sms_home_subject` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='首页专题表【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】';
...
CREATE TABLE `sms_home_subject_spu` (
  ...
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='专题商品';
...
CREATE TABLE `sms_member_price` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='商品会员价格';
...
CREATE TABLE `sms_seckill_promotion` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='秒杀活动';
...
CREATE TABLE `sms_seckill_session` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='秒杀活动场次';
...
CREATE TABLE `sms_seckill_sku_notice` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='秒杀商品通知订阅';
...
CREATE TABLE `sms_seckill_sku_relation` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='秒杀活动商品关联';
...
CREATE TABLE `sms_sku_full_reduction` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='商品满减信息';

-- ----------------------------
-- Records of sms_sku_full_reduction
-- ----------------------------
BEGIN;
INSERT INTO `sms_sku_full_reduction` VALUES (1, NULL, 10000.0000, 50.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (2, NULL, 5000.0000, 100.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (3, NULL, 5000.0000, 100.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (4, NULL, 5000.0000, 100.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (5, NULL, 5000.0000, 100.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (6, 15, 5000.0000, 100.0000, NULL);
COMMIT;
...
CREATE TABLE `sms_sku_ladder` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='商品阶梯价格';

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
BEGIN;
INSERT INTO `sms_sku_ladder` VALUES (1, NULL, 3, 1.00, NULL, 0);
INSERT INTO `sms_sku_ladder` VALUES (2, NULL, 2, 0.90, NULL, 1);
INSERT INTO `sms_sku_ladder` VALUES (3, NULL, 2, 0.90, NULL, 1);
INSERT INTO `sms_sku_ladder` VALUES (4, 11, 2, 0.90, NULL, 1);
INSERT INTO `sms_sku_ladder` VALUES (5, 12, 2, 0.90, NULL, 1);
INSERT INTO `sms_sku_ladder` VALUES (6, 15, 3, 1.00, NULL, 1);
COMMIT;
...
CREATE TABLE `sms_spu_bounds` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='商品spu积分设置';

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
BEGIN;
INSERT INTO `sms_spu_bounds` VALUES (2, 9, 10.0000, 10.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (3, 10, 10.0000, 10.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (4, 11, 10.0000, 10.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (5, 13, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (6, 14, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (7, 15, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (8, 16, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (9, 17, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (10, 18, 10.0000, 10.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (11, 19, 10.0000, 10.0000, NULL);
COMMIT;
